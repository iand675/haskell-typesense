...
1. An open source alternative to Algolia, with some key quirks solved
...
This version of the Haskell client library is currently tested against Typesense __v0.21__. Other versions may or may not work.
